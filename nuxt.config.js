...
module.exports = {
  ...
  head: {
    ...
    meta: [
      ...
      { property: 'twitter:description', content: 'Web Developer in the Nashville area with a passion for learning and creating custom websites and applications.', hid: 't:desc' },
      { property: 'twitter:domain', content: 'ryanwilldev.com', hid: 't:domain' },
      { property: 'twitter:tile', content: 'RyanWillDev', hid: 't:tile' },
    ],
  },
};
